setInterval(()=>{
    ...
    if(date.getHours()<=9)document.querySelector(".hour").innerHTML = `0${date.getHours()}`;
    document.querySelector(".minute").innerHTML = date.getMinutes();
    if(date.getMinutes() <=9)document.querySelector(".minute").innerHTML = `0${date.getMinutes()}`;
    document.querySelector(".second").innerHTML  = date.getSeconds();
    if(date.getSeconds() <=9)document.querySelector(".second").innerHTML = `0${date.getSeconds()}`;
